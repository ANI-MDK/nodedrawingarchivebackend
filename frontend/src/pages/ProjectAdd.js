...
const ProjectAdd = () => {
    ...
    const initialData = {name:"", code:"", location:"", state:"", desc:""};
    ...
    const crumbs = [
        ...
        { label: 'Add Project', path: '/projectadd' }
    ]

    useEffect(()=>{
        (permissions!==null && permissions.is_admin_user==="Y") ? navigate("/projectadd"): navigate("/dashboard")
    },[]);
    ...
    const handleProjectAddChange=(e)=>{
        const{ name, value} = e.target;
        setProject({...project, [name]:value});
    }

    const handelProjectAddSubmit= (e) =>{
        //console.log(project);
        e.preventDefault(); 
        axios.post(`${baseUrl}/project/createproject`,{project_name:project.name,project_code:project.code,project_location:project.location,project_state:project.state,project_description:project.desc},
            {headers: { 
                        ...
                        <div className="container mt-8">
                            <div className="flex flex-col items-center">
                                <div className="w-full max-w-5xl bg-cyan-700 bg-opacity-70 shadow-lg rounded-lg p-5 my-2">
                                    <h3 className="block text-lg font-medium text-gray-700 mb-1">Project Add Section:</h3>
                                    <form onSubmit={handelProjectAddSubmit}>
                                        <div className="bg-gray-100 shadow-lg rounded-lg p-5 mb-2">
                                            <div className="flex flex-wrap -mx-3 mb-2">
                                                <div className="w-full md:w-1/2 px-3 mb-2">
                                                    ...
                                                    <input type="text" id="name" name="name" value={project.name} placeholder="Enter Project Name here" onChange={handleProjectAddChange} className="mt-1 p-2 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500" required/>
                                                </div>
                                                <div className="w-full md:w-1/2 px-3 mb-2">
                                                    <label htmlFor="code" className="block text-sm font-medium text-gray-700"><span className="text-red-500">*</span>Project Code:</label>
                                                    <input type="text" id="code" name="code" value={project.code} placeholder="Enter Project Code here" onChange={handleProjectAddChange} className="mt-1 p-2 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500" required/>
                                                </div>
                                            </div>
                                            <div className="flex flex-wrap -mx-3 mb-2">
                                                <div className="w-full md:w-1/2 px-3 mb-2">
                                                    ...
                                                    <input type="text" id="location" name="location" value={project.location} placeholder="Enter Location here" onChange={handleProjectAddChange} className="mt-1 p-2 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500" required/>
                                                </div>
                                                <div className="w-full md:w-1/2 px-3 mb-2">
                                                    <label htmlFor="state" className="block text-sm font-medium text-gray-700"><span className="text-red-500">*</span>State:</label>
                                                    <select id="state" name="state" value={project.state} onChange={handleProjectAddChange} className="mt-1 p-2 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500" required>
                                            ...
                                            <div className="flex flex-wrap -mx-3">
                                                <div className="w-full px-3">
                                                    <label htmlFor="desc" className="block text-sm font-medium text-gray-700">Project Description:</label>
                                                    <textarea id="desc" name="desc" value={project.desc} placeholder="Enter Project Description here" onChange={handleProjectAddChange} className="mt-1 p-2 w-full border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gray-500 focus:border-gray-500"/>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="mt-4">
