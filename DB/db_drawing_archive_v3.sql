...
-- Dumping data for table db_drawing_archive.tbl_categories: ~4 rows (approximately)
...
-- Dumping data for table db_drawing_archive.tbl_download_logsheet: ~14 rows (approximately)
...
-- Dumping data for table db_drawing_archive.tbl_drawings: ~11 rows (approximately)
...
-- Dumping data for table db_drawing_archive.tbl_drawing_docs: ~15 rows (approximately)
...
-- Dumping data for table db_drawing_archive.tbl_projects: ~6 rows (approximately)
...
-- Dumping data for table db_drawing_archive.tbl_roles: ~15 rows (approximately)
...
-- Dumping data for table db_drawing_archive.tbl_users: ~17 rows (approximately)
...
-- Dumping data for table db_drawing_archive.tbl_user_project_mapping: ~16 rows (approximately)
